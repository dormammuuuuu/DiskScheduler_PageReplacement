...
! function(t, e) {
  ...
  class Xi extends Ei {
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? Hi(n.ticks, s) : n.ticks), n.configure(), n.beforeCalculateLabelRotation(), n.calculateLabelRotation(), n.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = Bi(n, n.ticks), n._labelSizes = null), a && n._convertTicksToLabels(n.ticks), n.beforeFit(), n.fit(), n.afterFit(), n.afterUpdate()
    }
    configure() {
      const t = this;
    ...
    _getLabelSizes() {
      ...
      if (!e) {
        ...
        let n = t.ticks;
        i < n.length && (n = Hi(n, i)), t._labelSizes = e = t._computeLabelSizes(n, n.length)
      }
      return e
    }
    ...
    drawTitle() {
      ...
      const {
        ...
        let c, h, d, u = 0;
        return t.isHorizontal() ? (h = o(n, a, l), d = Ni(t, i, e), c = l - a) : (h = Ni(t, i, e), d = o(n, r, s), u = "left" === i ? -Mt : Mt), {
          titleX: h,
          titleY: d,
          maxWidth: c,
          rotation: u
  ...
  function fn(t, e, i, n) {
    ...
    if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) dn(t);
      ...
      for (o = 0, s = t.length; o < s; ++o) a = t[o], r = hn(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension), a.cp1x = r.previous.x, a.cp1y = r.previous.y, a.cp2x = r.next.x, a.cp2y = r.next.y, i = a
    }
    e.capBezierPoints && function(t, e) {
      let i, n, o, s, a, r = Gt(t[0], e);
      for (i = 0, n = t.length; i < n; ++i) a = s, s = r, r = i < n - 1 && Gt(t[i + 1], e), s && (o = t[i], a && (o.cp1x = un(o.cp1x, e.left, e.right), o.cp1y = un(o.cp1y, e.top, e.bottom)), r && (o.cp2x = un(o.cp2x, e.left, e.right), o.cp2y = un(o.cp2y, e.top, e.bottom)))
    }(t, i)
  }
  ...
  function wn(t, e, i) {
    ...
    const y = () => b || l(o, x, p) && 0 !== r(o, x),
      v = () => !b || 0 === r(s, p) || l(s, x, p);
    for (let t = h, i = h; t <= d; ++t) m = e[t % a], m.skip || (p = c(m[n]), b = l(p, o, s), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(vn({
      start: _,
      end: t,
      loop: u,
      count: a,
  ...
  function ro(t, e, i, n) {
    const o = t.iScale,
      ...
      l = [];
    let c, h, d, u;
    for (c = i, h = i + n; c < h; ++c) u = e[c], d = {}, d[o.axis] = r || o.parse(a[c], c), l.push(ao(u, d, s, c));
    return l
  }
  ...
  class co extends Li {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g;
      for (d = i, u = i + n; d < u; ++d) g = e[d], f = {}, f[o.axis] = o.parse(lt(g, l), d), h.push(ao(lt(g, c), f, s, d));
      return h
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        ...
        o = this.getParsed(t),
        s = o._custom,
        a = lo(s) ? "[" + s.start + ", " + s.end + "]" : "" + n.getLabelForValue(o[n.axis]);
      return {
      ...
      for (let h = e; h < e + i; h++) {
        const e = o.getParsed(h),
          ...
          p = {
            horizontal: l,
            base: i.base,
            enableBorderRadius: !g || lo(e._custom) || o.index === g._top || o.index === g._bottom,
            x: l ? i.head : f.center,
            y: l ? f.center : i.head,
        ...
        } = e._getRotationExtents(),
        {
          ...
          if (e < _t) {
            const r = t,
              ...
              g = (t, e, n) => Nt(t, r, l) ? -1 : Math.min(e, e * i, n, n * i),
              p = f(0, c, d),
              m = f(Mt, h, u),
              x = g(bt, c, d),
              b = g(bt + Mt, h, u);
    ...
    update(t) {
      ...
      let {
        ...
        if (t._sorted) {
          ...
          d && (o = Ht(Math.min(oe(r, a.axis, c).lo, i ? n : oe(e, l, a.getPixelForValue(c)).lo), 0, n - 1)), s = u ? Ht(Math.max(oe(r, a.axis, h).hi + 1, i ? 0 : oe(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o : n - o
        }
        return {
          start: o,
          count: s
  ...
  function Mo(t, e) {
    ...
    i.borderWidth && (n ? (t.lineWidth = 2 * i.borderWidth, t.lineJoin = "round") : (t.lineWidth = i.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
      ...
      let h;
      for (i && (e.endAngle = e.startAngle + _t, _o(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += _t, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + _t, s, !0), h = 0; h < e.fullCircles; ++h) t.stroke();
  ...
  class $o extends Ei {
    ...
    draw(t) {
      const e = this.options,
        ...
        o = (s = n.radius).topLeft || s.topRight || s.bottomLeft || s.bottomRight ? ie : jo;
      var s;
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach(((e, o) => {
        ...
        let h, {
          ...
          return l && (o = Ht(oe(e, s.axis, a).lo, 0, i - 1)), n = c ? Ht(oe(e, s.axis, r).hi + 1, o, i) - o : i - o, {
            start: o,
            count: n
          }
        }(r, l);
  ...
  var ds = {
    ...
    afterDatasetsUpdate(t, e, i) {
      const n = (t.data.datasets || []).length,
        o = [];
      let s, a, r, l;
      for (a = 0; a < n; ++a) s = t.getDatasetMeta(a), r = s.dataset, l = null, r && r.options && r instanceof Lo && (l = {
      ...
      for (a = 0; a < n; ++a) l = o[a], l && !1 !== l.fill && (l.fill = ns(o, a, i.propagate))
    },
    beforeDraw(t, e, i) {
  ...
  class Cs extends Ei {
    ...
    drawTitle(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = Ss(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
      }
    }
    ...
    drawBody(t, e, i) {
      ...
      const f = xn(i.rtl, n.x, n.width),
        ...
        p = f.textAlign(a);
      let m, x, b, _, y, v, w;
      for (e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = Ss(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? "center" === a ? c / 2 + 1 : c + 2 : 0, _ = 0, v = o.length; _ < v; ++_) {
    ...
    drawFooter(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = Ss(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
      }
    }
  ...
  class Rs extends Xi {
    ...
    parse(t, e) {
      ...
      return ((t, e) => null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Ts(i, t, K(e, t)), i.length - 1)
    }
    determineDataLimits() {
      const t = this,
        {
    ...
    buildTicks() {
      ...
      const o = function(t, e) {
        const i = [],
          ...
          g = !$(s),
          p = !$(r);
        let m, x, b, _, y = Ct((u - d) / h / c) * c;
        if (y < 1e-14 && !f && !g) return [{
          value: d
        }, {
          value: u
        }];
        _ = Math.ceil(u / y) - Math.floor(d / y), _ > h && (y = Ct(_ * y / h / c) * c), $(a) || (m = Math.pow(10, a), y = Math.ceil(y * m) / m), x = Math.floor(d / y) * y, b = Math.ceil(u / y) * y, f && g && n && Rt((s - o) / n, y / 1e3) ? (_ = Math.min((s - o) / y, l), y = (s - o) / _, x = o, b = s) : p ? (x = f ? o : x, b = g ? s : b, _ = r - 1, y = (b - x) / _) : (_ = (b - x) / y, _ = Tt(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_)), m = Math.pow(10, $(a) ? zt(y) : a), x = Math.round(x * m) / m, b = Math.round(b * m) / m;
        let v = 0;
        for (f && (i.push({
            value: o
          }), x <= o && v++, Tt(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v) i.push({
          value: Math.round((x + v * y) * m) / m
        });
        return g ? Tt(i[i.length - 1].value, s, y / 10) ? i[i.length - 1].value = s : i.push({
          value: s
        }) : i.push({
          value: b
        }), i
  ...
  class js extends Ls {
    ...
    _setReductions(t, e, i) {
      ...
      o = Hs(o), s = Hs(s), a = Hs(a), r = Hs(r), n.drawingArea = Math.max(t / 2, Math.min(Math.floor(t - (o + s) / 2), Math.floor(t - (a + r) / 2))), n.setCenterPoint(o, s, a, r)
    }
    ...
    drawBackground() {
      ...
      if (e) {
        const n = t.ctx;
        n.save(), n.beginPath(), Ns(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length), n.closePath(), n.fillStyle = e, n.fill(), n.restore()
      }
    }
    drawGrid() {
      const t = this,
      ...
      if (i.pointLabels.display && function(t, e) {
          ...
          if (0 !== i) {
            ...
            ! function(t, e, i, n) {
              ...
              !s && !n || !a || !r || i < 0 || (o.save(), o.strokeStyle = a, o.lineWidth = r, o.setLineDash(e.borderDash), o.lineDashOffset = e.borderDashOffset, o.beginPath(), Ns(t, i, s, n), o.closePath(), o.stroke(), o.restore())
            }(t, n, r, s)
          }
        })), n.display) {
